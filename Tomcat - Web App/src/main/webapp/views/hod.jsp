...
<body>
	<div class="defaultSVG">
		...
		<div class="authbox1">
		<div>
		    <h2 class="text-center">View Department Marks</h2>
		</div>
		<br><br>
		<div>
		<form class="authboxS1" action="${pageContext.request.contextPath}/hod" method="POST">
        	...
        	<input id="semester" name="semester" placeholder="1" type="text" class="formInput form-control">
		    </div><br><br>
